...
The main security concern with my homelab was that the core switch had not been properly locked down. This document outlines the issues identified in the original configuration and the steps taken to resolve them.

## Table of Contents

*   [Original (Insecure) Configuration](#original-insecure-configuration)
    
*   [Issues Identified](#issues-identified)
    *   [HTTP Server Enabled](#http-server-enabled)
        
    *   [Management on Default VLAN 1](#management-on-default-vlan-1)
        
    *   [Native VLAN Not Hardened](#native-vlan-not-hardened)
        
    *   [No Port Security](#no-port-security)
        
    *   [Trunk Ports Negotiating via DTP](#trunk-ports-negotiating-via-dtp)
        
*   [Final Secured Configuration](#final-secured-configuration)
